/*
  WordClockWordTest.ino
  Cycles through every defined word, one at a time, 1 second each.
...
int H_quarter[]    = { 101,98,93,90,85,82,77 };
...
void loop() {
  ...
  // Brief pause between full cycles so you can see the reset
  pixels.clear();
  pixels.show();
  Serial.println("\n[DIAG] --- cycle complete ---\n");
  delay(500);
